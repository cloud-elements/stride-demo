...
var cloudelementsControllerFunc = function($scope, $http, $interval) {
        ...
        //Take the contact details from the UI and sends them to the createContact route which will post them to Salesforce
...
angular.module('cloudelements')
    .controller('cloudelementsController', ['$scope', '$http', '$interval', cloudelementsControllerFunc]);